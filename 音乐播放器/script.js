const LYRICS_TIME_OFFSET = {
    ...
    "Booty Music.txt": 0,
    "Brain Power.txt": 0,
    "Burn It All Down.txt": 0,
    "Confession.txt": 0,
    "Cotton Eye Joe.txt": 0,
    "Crucified.txt": 0,
    "Cure For Me.txt": 0,
    "Cyberangel.txt": 0,
    "Cyka Blyat.txt": 0,
    ...
    "DISCO NIGHT.txt": 0,
    "Disco Panzer.txt": 0,
    "Do Better&Neon Rainbow.txt": 0,
    "Dreamy Day.txt": 0,
    "Everywhere We Go.txt": 0,
    "EZ4ENCE.txt": 0,
    "Flamingo.txt": 0,
    "Flashbang dance.txt": 0,
    "Gentle Man.txt": 0,
    "Gimme More x step on up.txt": 0,
    "GoneBad.txt": 0,
    "GOTCHA！.txt": 0,
    "Green Screen.txt": 0,
    "Higher Fighter.txt": 0,
    "HIT ME UP.txt": 0,
    "Hush.txt": 0,
    // 第3批歌曲 (41-60)
    "I Miss You.txt": 0,
    ...
    "infinity.txt": 0,
    "Insomnia.txt": 0,
    "Intergalactic Bound.txt": 0,
    "INTERNET OVERDOSE.txt": 0,
    "Just Friends.txt": 0,
    ...
    "La La La.txt": 0,
    "Latitude.txt": 0,
    "level5 judgelight.txt": 0,
    "Lightning moment.txt": 0,
    "Lose Control.txt": 0,
    "ManiFesto.txt": 0,
    "mede：mede.txt": 0,
    "Melody.txt": 0,
    "Messages from the Stars.txt": 0,
    "Middle Of The Night.txt": 0,
    // 第4批歌曲 (61-80)
    "miku miku oo ee oo.txt": 0,
    "Monody.txt": 0,
    "MONTAGEM CORAL.txt": 0,
    "Moon Halo.txt": 0,
    "MORE.txt": 0,
    "Moves Like Jagger.txt": 0,
    "M八七.txt": 0,
    "Never Gonna Give You Up.txt": 0,
    "New Face.txt": 0,
    "New Rules(Remix).txt": 0,
    "NO CAP.txt": 0,
    "Normal No More.txt": 0,
    "NOX LUX.txt": 0,
    "nuits d'été.txt": 0,
    "Nyan Cat.txt": 0,
    "Once Upon a Time.txt": 0,
    "one spot.txt": 0,
    "Only My Railgun.txt": 0,
    "OTTAMA GAZER.txt": 0,
    "POP STARS.txt": 0,
    // 第5批歌曲 (81-100)
    "Reburn.txt": 0,
    ...
    "SOS.txt": 0,
    "SPECIALZ.txt": 0,
    "SPEED OF LIGHT.txt": 0,
    "Spirit.txt": 0,
    "Stan.txt": 0,
    "Starfall.txt": 0,
    "Sunshine Girl.txt": 0,
    "TAKE ME HIGHER.txt": 0,
    // 第6批歌曲 (101-120)
    "Take On Me.txt": 0,
    "The Ocean.txt": 0,
    "Thrift Shop.txt": 0,
    "Throw It All Away.txt": 0,
    "Toxic.txt": 0,
    "True Fighter.txt": 0,
    "TruE.txt": 0,
    "UNO.txt": 0,
    "Untitled world.txt": 0,
    "Unwelcome school.txt": 0,
    "Verbatim.txt": 0,
    "VOODOO KINGDOM.txt": 0,
